...
<section id="how">
  ...
  <div class="steps">
    ...
    <div class="step"><div class="step-num">2</div><h3>Upload your content</h3><p>Upload any image, GIF, or video file up to 12 hours long. We support all formats.</p></div>
...
<section>
  ...
  <div class="comparison">
    ...
    <div class="comparison-row"><div class="feature">24/7 streaming</div><div class="ours" style="color:#aaff00">✓</div><div class="theirs" style="color:#aaff00">✓</div></div>
    <div class="comparison-row"><div class="feature">1080p quality</div><div class="ours" style="color:#aaff00">✓</div><div class="theirs" style="color:#aaff00">✓</div></div>
    <div class="comparison-row"><div class="feature">Image, GIF &amp; video support</div><div class="ours" style="color:#aaff00">✓</div><div class="theirs" style="color:#aaff00">✓</div></div>
    <div class="comparison-row"><div class="feature">Auto-restart on crash</div><div class="ours" style="color:#aaff00">✓</div><div class="theirs" style="color:#aaff00">✓</div></div>
    <div class="comparison-row"><div class="feature">Video loops up to 12 hours</div><div class="ours" style="color:#aaff00">✓</div><div class="theirs" style="color:#f87171">✗ extra cost</div></div>
    <div class="comparison-row"><div class="feature">No watermark</div><div class="ours" style="color:#aaff00">✓</div><div class="theirs" style="color:#f87171">✗ paid plans only</div></div>
  </div>
</section>
...
<section id="faq">
  ...
  <div class="faq">
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Do I need to keep my computer on? <span class="faq-arrow">▼</span></div><div class="faq-a">No. Once you start your stream it runs on our servers 24/7. You can turn off your PC completely.</div></div>
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">What file types are supported? <span class="faq-arrow">▼</span></div><div class="faq-a">We support images (JPG, PNG, WebP), GIFs, and videos (MP4, MOV, AVI, MKV, WebM). Files can be up to 20GB.</div></div>
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Where do I find my YouTube stream key? <span class="faq-arrow">▼</span></div><div class="faq-a">Go to YouTube Studio → Go Live → Stream. Your stream key is listed there. Keep it private — anyone with it can stream to your channel.</div></div>
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">What happens if the stream crashes? <span class="faq-arrow">▼</span></div><div class="faq-a">Our system automatically detects crashes and restarts your stream within seconds. No action needed from you.</div></div>
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Can I change my video after the stream starts? <span class="faq-arrow">▼</span></div><div class="faq-a">Yes. Stop your stream, upload a new file, and restart. The whole process takes less than a minute.</div></div>
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Is this against YouTube's terms of service? <span class="faq-arrow">▼</span></div><div class="faq-a">No. Streaming pre-recorded content is explicitly allowed by YouTube. Thousands of channels do this for lofi, ambient, study music and more.</div></div>
    <div class="faq-item"><div class="faq-q" onclick="toggleFaq(this)">Can I cancel anytime? <span class="faq-arrow">▼</span></div><div class="faq-a">Yes. Cancel anytime from your dashboard. No contracts, no cancellation fees.</div></div>
  </div>
</section>
...
<div class="card">
  ...
  <div class="field">
    ...
    <div class="plan-select">
      <div class="plan-opt ${plan === 'starter' ? 'selected' : ''}" id="plan-starter" onclick="selectPlan('starter')">
        <div class="price">$2</div><div class="name">Starter</div><div class="streams">1 stream · 720p</div>
      </div>
      <div class="plan-opt ${plan === 'pro' ? 'selected' : ''}" id="plan-pro" onclick="selectPlan('pro')">
        <div class="price">$5</div><div class="name">Pro ⭐</div><div class="streams">1 stream · 1080p</div>
      </div>
      <div class="plan-opt ${plan === 'creator' ? 'selected' : ''}" id="plan-creator" onclick="selectPlan('creator')">
        <div class="price">$12</div><div class="name">Creator</div><div class="streams">3 streams · 1080p</div>
      </div>
      <div class="plan-opt ${plan === 'studio' ? 'selected' : ''}" id="plan-studio" onclick="selectPlan('studio')">
        <div class="price">$20</div><div class="name">Studio</div><div class="streams">6 streams · 1080p</div>
      </div>
    </div>
  </div>
  <div class="field">
  ...
  <button class="btn" id="register-btn" onclick="register()">Create account</button>
  <div class="link">Already have an account? <a href="/login">Log in</a></div>
  <div style="font-size:11px;color:#333;text-align:center;margin-top:1rem;">Payment details collected after signup</div>
</div>
<script>
...
async function register() {
  ...
  try {
    ...
    if (data.error) { errorEl.textContent = data.error; errorEl.style.display = 'block'; btn.disabled = false; btn.textContent = 'Create account'; return; }
    window.location.href = '/dashboard';
  } catch(e) { errorEl.textContent = 'Something went wrong. Please try again.'; errorEl.style.display = 'block'; btn.disabled = false; btn.textContent = 'Create account'; }
}
...
async function login() {
  ...
  try {
    ...
    const data = await res.json();
    if (data.error) { errorEl.textContent = data.error; errorEl.style.display = 'block'; btn.disabled = false; btn.textContent = 'Log in'; return; }
    window.location.href = '/dashboard';
  } catch(e) { errorEl.textContent = 'Something went wrong. Please try again.'; errorEl.style.display = 'block'; btn.disabled = false; btn.textContent = 'Log in'; }
}
...
<body>
<div class="topbar">
  <a href="/" class="logo">stream<span>forcheap</span></a>
...
<div class="modal-overlay" id="stream-modal">
  <div class="modal">
    ...
    <div class="field">
      ...
      <div class="field-note">Find this in YouTube Studio → Go Live → Stream. Keep it private — anyone with it can stream to your channel.</div>
    </div>
    <div class="field">
    ...
    ` : streams.map(s => {
      ...
      <div class="stream-card" id="stream-${s.id}">
        ...
        <div class="stream-actions">
          ...
          <button class="btn-edit" onclick="editStream(${s.id}, \`${s.name.replace(/`/g,"'")}\`, \`${(s.stream_key||'').replace(/`/g,"'")}\`, '${s.resolution}')">✏️ Edit</button>
...
function openModal() {
  editingStreamId = null; selectedFile = null;
...
async function saveStream() {
  ...
  saveBtn.disabled = true; saveBtn.textContent = 'Saving...'; errorEl.style.display = 'none';

  if (editingStreamId) {
    const r = await fetch('/api/streams/' + editingStreamId, { method: 'PUT', headers: {'Content-Type':'application/json'}, body: JSON.stringify({ name, streamKey: key, resolution: res }) });
    const data = await r.json();
    if (data.error) { errorEl.textContent = data.error; errorEl.style.display = 'block'; saveBtn.disabled = false; saveBtn.textContent = 'Save stream'; return; }
    closeModal(); location.reload(); return;
  }

  const r = await fetch('/api/streams', { method: 'POST', headers: {'Content-Type':'application/json'}, body: JSON.stringify({ name, streamKey: key, resolution: res }) });
  const data = await r.json();
  if (data.error) { errorEl.textContent = data.error; errorEl.style.display = 'block'; saveBtn.disabled = false; saveBtn.textContent = 'Save stream'; return; }
  ...
  if (selectedFile) {
    ...
    xhr.upload.onprogress = (e) => {
      if (e.lengthComputable) { const pct = Math.round(e.loaded/e.total*100); progressFill.style.width = pct+'%'; progressLabel.textContent = 'Uploading '+pct+'%...'; }
    };
    xhr.onload = () => {
      if (xhr.status === 200) { closeModal(); location.reload(); }
      else { errorEl.textContent = 'File upload failed. Please try again.'; errorEl.style.display = 'block'; saveBtn.disabled = false; saveBtn.textContent = 'Save stream'; }
    };
    xhr.onerror = () => { errorEl.textContent = 'Upload error. Please try again.'; errorEl.style.display = 'block'; saveBtn.disabled = false; saveBtn.textContent = 'Save stream'; };
    xhr.open('POST', '/api/streams/' + data.id + '/upload');
    xhr.send(formData);
...
async function startStream(id) {
  ...
  const data = await res.json();
  if (data.error) { alert(data.error); if (btn) { btn.textContent = '▶ Start stream'; btn.disabled = false; } return; }
  location.reload();
}
...
app.put('/api/streams/:id', requireAuth, async (req, res) => {
  try {
    ...
    await pool.query('UPDATE streams SET name = $1, stream_key = $2, resolution = $3 WHERE id = $4',
